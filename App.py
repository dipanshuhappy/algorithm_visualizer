...
class AlgorithmVisualizer(Tk):
    ...
    def create_algorithm_buttons(self):
        ...
        game_of_life=ttk.Button(button_frame,text='Game of Life',width=60,command=self.on_game_of_life)
        game_of_life.grid(row=0,column=0)
        towers_of_hanoi=ttk.Button(button_frame,text='Towers of Hanoi',width=60,command=self.on_towers_of_hanoi)
        towers_of_hanoi.grid(row=1,column=1)
        selection_sort=ttk.Button(button_frame,text='Selection Sort',width=60,command=self.on_selection_sort)
        selection_sort.grid(row=0,column=2)
        quick_sort=ttk.Button(button_frame,text='Quick Sort',width=68,command=self.on_quick_sort)
